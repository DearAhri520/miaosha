...
// ============================String=============================
    ...
    /**
     * 根据prefix,key和clazz,获取一个java bean
     *
     * @param prefix 前缀
     * @param key    键
     * @param clazz  clazz
     ...
     * @return java bean
     */
    <T> T get(Prefix prefix, String key, Class<T> clazz);
     ...
     * @return true成功 false失败
     */
    <T> boolean set(Prefix prefix,String key, T value);
     ...
     * @return true成功 false失败
     */
    <T> boolean set(Prefix prefix,String key, T value,long time);
